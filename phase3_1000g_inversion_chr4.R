...
#first, read in vcf for chr4 (phase 3)

#vcfR::read.vcfR('/mnt/sequencedb/1000Genomes/ftp/phase3/20140910/ALL.chr4.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz', verbose = TRUE)-> chr4ph3
#AND THIS IS THE vcf without lines that don't have AA=

data.table::fread("zcat /mnt/sequencedb/1000Genomes/ftp/phase3/20140910/ALL.chr4.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sep="\t")-> test

#vcfR::read.vcfR('/mnt/sequencedb/PopGen/barbara/inversions/balsel/chr4_withAnc_info.vcf.gz', verbose=TRUE)-> chr4ph3_withAA
